function result = DBsim_eps_fusion(alpha,N, iter,p_ini, b,eps,beta)
...
%         hhhhhhh = randperm(N, round(eps * N));
%         obv(hhhhhhh) = ~sys(hhhhhhh);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        rep = obv ;
        repnoin = obv;
